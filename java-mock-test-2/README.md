...
## 1. What is bytecode?
Bytecode is an intermediate, low-level code generated by the Java compiler when it translates Java source code (files with a .java extension) into a platform-independent format (files with a .class extension). It is executed by JVM.
